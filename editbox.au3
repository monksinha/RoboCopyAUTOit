...
Func _Main()
	...
	Local $idEdit_1, $idOK_Btn, $idCancel_Btn, $iMsg, $String
	...
	$idEdit_1 = GUICtrlCreateInput("Hakuna", 10, 10, 280, 190)


	$String = GUICtrlRead($idEdit_1)
