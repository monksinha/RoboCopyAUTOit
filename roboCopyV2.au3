...
Global $Source, $Destination, $String1, $String2
...
Func _Main()
   ...
   #forceref $idEdit_2
	...
	$Source = GUICtrlCreateEdit("", 10, 50, 380, 45)

	$SelectSourceBtn = GUICtrlCreateButton("...",410,50,40)
    ;GUICtrlSetState ( $Source, $GUI_DROPACCEPTED )


	;Create an edit box with no text in it
    GUICtrlCreateLabel("Destination Folder",10,130); left, top
	$Destination= GUICtrlCreateEdit("", 10, 150, 380, 45)
		...
		Select
			...
			Case $iMsg = $GUI_EVENT_CLOSE
			 ...
			 Case $iMsg = $CopyCommandBtn
                ...
                if($Count>0) Then
				   GUICtrlSetData($Source, $String1)
				  GUICtrlSetData($Destination, $String2)
				EndIf
				$Count++
