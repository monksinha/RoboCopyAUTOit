...
Func _Main()
	...
	GUICreate("My GUI edit",500,600,-1,-1,-1, $WS_EX_ACCEPTFILES)
	...
	GUICtrlSetState($SourceBox,$GUI_DROPACCEPTED)
	...
	$DestinationBox= GUICtrlCreateEdit("", 10, 150, 380, 45)
	 ...
	 ;GUICtrlSetState($DestinationBox,$GUI_DROPACCEPTED)
    ...
    GUICtrlCreateLabel("---COPY SPEED---",180,225)
	 ...
	 $Speed120 = GUICtrlCreateRadio("Fastest", 380,260, 150)
	  ...
	  GuiCtrlCreateLabel("V.2.0",10,570)
...
Func Drag()
   MsgBox(0,"here","I am")
    GUICtrlSetData($SourceBox, @GUI_DRAGFILE)
EndFunc